...
fig = plot(samples)
plt.savefig('visualization/max_class_w_G.png', bbox_inches='tight')
plt.close(fig)
...
fig = plot(samples[0:100])
plt.savefig('visualization/max_features_no_G_layer2.png', bbox_inches='tight')
plt.close(fig)

for i in range(200):
    output = model(X, 8) #100*196
...
fig = plot(samples[0:100])
plt.savefig('visualization/max_features_no_G_layer8.png', bbox_inches='tight')
plt.close(fig)
...
fig = plot(samples[0:100])
plt.savefig('visualization/max_features_with_G_layer2.png', bbox_inches='tight')
plt.close(fig)
...
fig = plot(samples[0:100])
plt.savefig('visualization/max_features_with_G_layer8.png', bbox_inches='tight')
plt.close(fig)
